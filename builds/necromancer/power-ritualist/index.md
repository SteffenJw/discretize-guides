...
On spear, <Skill id="73007" /> (Spear 5), <Skill id="73013"/> (Spear 3), <Skill id="73107"/> (Spear 4.2) create soul shards which can be consumed by <Skill id="73068"/> (Spear 2) for extra damage.  <Skill id="73107"/> resets <Skill id="73068"/>. <Skill id="73068"/> and <Skill name="Gravedigger" /> (GS 2) have improved effects against low-hp targets.
...
or 
1. <Skill id="73007" /> (Spear 5) to strip <Instability name="No Pain, No Gain"/> \
  Activate the boss during the cast.
2. <Skill id="73013"/> (Spear 3) to help with the breakbar and trigger <Item id="103574"/>. Careful not to cancel <Skill id="73007" /> by spamming.
...
7. <Skill id="73013"/> (Spear 3) if available
8. _Weapon Swap_
